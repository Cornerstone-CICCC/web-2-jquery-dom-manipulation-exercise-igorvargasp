...
$(function() {
    ...
    $("#exercise2Button").on('click', function() {
      $("#exercise2 p").parent().css('background-color', 'lightblue');
    });
    ...
    $("#exercise4Button").on('click', function() {
      $(this).siblings('h3').siblings('p').eq(1).hide();
    });
    ...
    $("#exercise5Button").on('click', function() {
      $(this).siblings('div').children('p').css('border', '2px solid black');
    });
    ...
    $("#exercise6Button").on('click', function() {
      $(this).prev('div').find('ul li span').css('color', 'red');
    });
})